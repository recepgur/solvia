...
class SecurityDataCollector:
    ...
    def fetch_nvd_vulnerabilities(self, days_back=365):
        ...
        while total_fetched < 1100:  # Fetch slightly more than 1000 to account for filtering
            params = {
            ...
            try:
                ...
                response = requests.get(self.nvd_api_base, params=params, headers=self.headers)
                ...
                if response.status_code == 200:
                    ...
                    print(f"Fetched {fetched_count} vulnerabilities (Total: {total_fetched})")
