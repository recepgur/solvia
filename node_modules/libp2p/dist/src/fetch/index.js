...
class DefaultFetchService {
    ...
    async fetch(peer, key, options = {}) {
        ...
        try {
            ...
            log('fetch %s', key);
            const result = await pipe([FetchRequest.encode({ identifier: key })], (source) => lp.encode(source), source, (source) => lp.decode(source), async function (source) {
...
export function fetchService(init = {}) {
