...
export declare class DefaultUpgrader implements Upgrader {
     ...
     */
    _encryptInbound(connection: Duplex<AsyncGenerator<Uint8Array>, Source<Uint8Array>>): Promise<CryptoResult>;
    /**
    ...
    _multiplexOutbound(connection: MultiaddrConnection, muxers: Map<string, StreamMuxerFactory>): Promise<{
        stream: Duplex<AsyncGenerator<Uint8Array>, Source<Uint8Array>, Promise<void>>;
        muxerFactory?: StreamMuxerFactory;
    }>;
    /**
