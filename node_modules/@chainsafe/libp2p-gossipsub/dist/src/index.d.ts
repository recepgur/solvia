import { TypedEventEmitter, StrictSign, StrictNoSign, TopicValidatorResult } from '@libp2p/interface';
...
import type { PeerId, PeerStore, Message, PublishResult, PubSub, PubSubEvents, PubSubInit, TopicValidatorFn, Logger, ComponentLogger } from '@libp2p/interface';
