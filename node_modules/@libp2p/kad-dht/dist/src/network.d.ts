...
import type { AbortOptions, Stream, PeerId, PeerInfo, Startable } from '@libp2p/interface';
...
export declare class Network extends TypedEventEmitter<NetworkEvents> implements Startable {
     ...
     */
    _writeMessage(stream: Stream, msg: Message, options: AbortOptions): Promise<void>;
    /**
     * Write a message and read its response.
     * If no response is received after the specified timeout
     * this will error out.
     */
    _writeReadMessage(stream: Stream, msg: Message, options: AbortOptions): Promise<Message>;
}
export {};
