    ...
    def load_agent_patterns(self):
        ...
        agent_patterns = {
            ...
            'stealth': {
                ...
                'mitre_tactics': ['defense-evasion', 'discovery', 'persistence', 'privilege-escalation']
            },
            'learning': {
        ...
        for mechanism, details in agent_patterns.items():
            pattern_entry = {
                ...
                'learning_features': json.dumps(self._generate_learning_features(mechanism))
            }
